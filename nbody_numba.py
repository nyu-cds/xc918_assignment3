"""
    ...
    vec_deltas does not improve the performance well maybe due to the dimension of the data set.
...
def vec_deltas(x_vec, y_vec):
    return x_vec - y_vec

@jit#("void(float64, dict")
...
@jit#("void(tuple, dict, float64, float64, float64)")
...
@jit#("void(int32, char, int32, dict)")
