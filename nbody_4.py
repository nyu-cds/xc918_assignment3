"""
    ...
    This is the first requirement: Using data aggregation to reduce loop overheads
    Using data aggregation to reduce loop overheads ---ONLY--- in this file.
        
    First test, 86s.
    Second test, 86.9s.

    Running time: 77.7s. Imporved. :)
"""
