...
cdef set Pairwise_name = set(combinations(BODIES,2))# combination gives all pairs of 5 factors, such as (sun, jupiter), (sun, uranus).



cdef advance(float dt, dict BODIES):
    '''
    ...
    cdef float m1, m2, mag, m1_mag, m2_mag
    cdef float dx, dy, dz, m, vx, vy, vz
...
cdef float report_energy(dict BODIES, float e=0.0):
    '''
